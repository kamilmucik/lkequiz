	...
	<div id="page" class="site grid-container">
		<footer id="colophon" class="site-footer">
			...
			<div class="site-info">
				...
				<?php echo esc_html__(' | Theme by', 'superb-landingpage') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'superb-landingpage'); ?>" rel="nofollow noopener"><?php echo esc_html__(' Superb WordPress Themes', 'superb-landingpage') ?></a>
				</span>
