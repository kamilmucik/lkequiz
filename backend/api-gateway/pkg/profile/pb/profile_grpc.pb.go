...
const (
	ProfileService_FindOne_FullMethodName       = "/profile.ProfileService/FindOne"
...
func (c *profileServiceClient) FindOne(ctx context.Context, in *FindOneRequest, opts ...grpc.CallOption) (*FindOneResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProfileService_FindOne_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileService_FindOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_FindOne_FullMethodName,
	}
