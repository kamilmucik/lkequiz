...
kubectl apply -f gateway-svc-config.yaml
kubectl apply -f gateway-svc-deployment.yaml
kubectl apply -f gateway-svc-svc.yaml

kubectl apply -f front-svc-config.yaml
kubectl apply -f front-svc-deployment.yaml
kubectl apply -f front-svc-svc.yaml
