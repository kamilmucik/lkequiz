...
export default function SignUpScreen(){
    ...
    const handleSignUp = async() => {
        ...
        //     Alert.alert("Error", "Hasło musi miec min 3 znaki");
        // }
        ...
        try {
            ...
            console.error(error);
            Alert.alert("Error", "Failed to sign up. Spróbuj później.")
        } finally {
            setIsLoading(false);
        }
    }
                ...
                <View style={styles.form}>
                    ...
                    <TouchableOpacity 
                        ...
                        <Text style={styles.linkButtonText}>
                            Back to <Text style={styles.linkButtonTextBold}>Login</Text>
                        </Text>
                    </TouchableOpacity>
                </View>
            </View>
